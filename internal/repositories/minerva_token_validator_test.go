...
func TestValidate(t *testing.T) {
	...
	t.Run("Test an expired token", func(t *testing.T) {
		...
		if err != domain.ErrExpiredToken {
			t.Errorf("Expected error: %q got: %q", domain.ErrExpiredToken, err)
		}
	})
	...
	t.Run("Test an invalid token", func(t *testing.T) {
		...
		if err != domain.ErrInvalidToken {
			t.Errorf("Expected error: %q got: %q", domain.ErrInvalidToken, err)
		}
	})
	...
	t.Run("Test an token without user", func(t *testing.T) {
		...
		if err != domain.ErrNoUsrInToken {
			t.Errorf("Expected error: %q got: %q", domain.ErrNoUsrInToken, err)
		}
	})
...
func TestValidateWithUse(t *testing.T) {
	...
	t.Run("Test an token with invalid use", func(t *testing.T) {
		...
		if err != domain.ErrInvalidTokenUse {
			t.Errorf("Expected error: %q got: %q", domain.ErrInvalidTokenUse, err)
		}
	})
}
